...
const globalStyles = StyleSheet.create({
  ...
  dot: { position: 'absolute', top: 2, right: 2, width: 8, height: 8, backgroundColor: '#ef4444', borderRadius: 4, borderWidth: 1, borderColor: '#2564eb00' },
  ...
  resourcesSection: { backgroundColor: '#fde9fdff', padding: 16, borderRadius: 12, marginTop: 24 },
